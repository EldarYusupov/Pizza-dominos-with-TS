...
import CartItem from "../componentns/CartItem.tsx";
import {cartSelector, clearItems} from "../redux/slices/cartSlice.ts";
import CartEmpty from "../componentns/CartEmpty.tsx";
        ...
        <div className="container container--cart">
            <div className="cart">
                ...
                <div className="content__items">
                    {
                        items.map((el:any) => <CartItem {...el} key={el.id}/> )
                    }
